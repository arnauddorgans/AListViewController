...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/AListViewController/AListViewController.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/SwiftEmoji/SwiftEmoji.framework"
fi
